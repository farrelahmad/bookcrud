...
<html lang="en">
  ...
  <body class="bg-light">
    <main class="container">
      ...
      @endif
<!-- START FORM -->
      <form action='{{ url('book/'.$data->nmbook) }}' method='post'>
        @csrf
        @method('PUT')
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='nmbook' id="nmbook" value="{{ $data->nmbook }}">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="nmpenulis" class="col-sm-2 col-form-label">Nama Penulis</label>
                <div class="col-sm-10">
                  <h3>{{ $data->nmpenulis }}</h3>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="halaman" class="col-sm-2 col-form-label">Halaman</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" name='halaman' id="halaman" value="{{ $data->halaman }}">
                </div>
            </div>
            <div class="mb-3 row">
